<?php
@session_start();
$db = mysqli_connect("localhost", "root", "", "e-learning-db");
?>
<!DOCTYPE html>
<html>
<head>
...
<body>
                        ...
                        if(@$_POST['login']) {
                            ...
                            if(mysqli_num_rows($sql) > 0) {
                                if($data['status'] == 'aktif') {
                                    ...
                                    echo '<div class="alert alert-warning">Login gagal, akun Anda Belum aktif</div>';
                                }
                            } else {
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    &copy; 2020 E-Learing SMK Indonesia | By : wahyu
                </div>
